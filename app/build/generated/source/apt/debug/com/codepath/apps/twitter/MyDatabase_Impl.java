...
import com.codepath.apps.twitter.models.SampleModelDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoSampleModel.equals(_existingSampleModel)) {
          throw new IllegalStateException("Migration didn't properly handle SampleModel(com.codepath.apps.twitter.models.SampleModel).\n"
                  + " Expected:\n" + _infoSampleModel + "\n"
